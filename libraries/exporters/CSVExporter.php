...
class CSVExporter implements IExporterHandler {
	...
	/**
	 * @var Transactions_products_param[]|null
	 */
	...
	protected function prepareRefundBankInfo(): void {
		...
		$param = new Transactions_products_param();
	...
	protected function getRefundBankInfo(int $transaction): ?Transactions_products_param {
