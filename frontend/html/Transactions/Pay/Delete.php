			...
			<div class="alert alert-block alert-warning fade in">
				<div class="row">
					<div class="col-xs-12">
						...
						<p>
							<?php echo t('transaction.pay.delete.warning', ['pay.id' => $this->pay->id]); ?>
						</p>
					</div>
				</div>
				<?php
                if (1 == count($this->pay->transaction->pays)) {
					...
					<?php
                        $this->createfield([
                            ...
                            'options' => [
                                [
                                    'label' => t('financial.transaction.pay.delete.triggered'),
                                    'value' => 1,
                                ],
                            ],
                        ]);
				...
				<div class="row">
					<div class="col-xs-12">
						<a href="<?php echo userpanel\url('transactions/edit/'.$this->pay->transaction->id); ?>" class="btn btn-light-grey"><i class="fa fa-chevron-circle-right"></i> <?php echo t('return'); ?></a>
