...
<?php if ($this->canAccept) { ?>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="tabbable">
					...
					<?php if (Account::Active != $this->account->status) { ?>
						<li class="active">
    ...
    if (Account::Rejected != $this->account->status) {
        ?>
						<li <?php echo Account::Active == $this->account->status ? 'class="active"' : ''; ?>>
    ...
    if (Account::Rejected != $this->account->status) {
        ?>
						<div class="tab-pane<?php echo Account::Active == $this->account->status ? ' active' : ''; ?>" id="reject-banks-account">
