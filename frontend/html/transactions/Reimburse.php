...
<div class="panel panel-default">
	<div class="panel-heading">
		<i class="fa fa-money"></i> <?php echo t('packages.financial.reimburse.title_with_id', ['transaction_id' => $this->transaction->id]); ?>
		...
		<form id="reimburse-transaction-form" action="<?php echo url("transactions/{$this->transaction->id}/reimburse"); ?>" method="POST">
			<div class="row">
				<div class="col-sm-5 help-text-container">
					...
					<?php
                    echo t('packages.financial.reimburse.help_text', [
