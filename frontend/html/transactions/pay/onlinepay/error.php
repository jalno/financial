...
<div class="row">
	<div class="col-sm-12 page-error">
		<div class="error-details col-sm-6 col-sm-offset-3">
			<?php if($this->getError()['error'] == 'gateway'){ ?><div class="error-number bricky">500</div><?php } ?>
			<h3><?php echo translator::trans('pay.online.error.'.$this->getError()['error']); ?></h3>
			<p><?php echo translator::trans('pay.online.error.'.$this->getError()['error'].'.text'); ?></p>
			<p>
				<div class="btn-group">
