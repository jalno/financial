...
<div class="row">
	<div class="col-xs-12 page-error">
		<div class="error-details col-sm-6 col-sm-offset-3">
			...
			<h3><?php echo t('pay.redirect.wait'); ?></h3>
			<p><?php echo t('pay.redirect.text'); ?></p>
			<form id="onlinepay_redirect_form" action="<?php echo $redirect->getURL(); ?>" method="<?php echo $redirect->method; ?>">
				<?php $this->createFormData(); ?>
				<p><?php echo t('pay.redirect.manual', [
				    'submit' => '<button type="submit" class="btn btn-primary">'.t('here').'</button>',
				]); ?></p>
			</form>
		</div>
	</div>
