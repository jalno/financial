					...
					<div class="col-md-6">
						<div class="guest-pay-link">
							...
							<div class="input-group">
								<input type="text" class="form-control ltr" id="financial-guest-pay" value="<?php echo userpanel\url('transactions/pay/'.$this->transaction->id, ['token' => $this->transaction->token], true); ?>">
...
foreach ($this->methods as $method) {
    $icon = Utility::switchcase($method, [
        'fa fa-university' => 'banktransfer',
        'fa fa-money' => 'onlinepay',
        'fa fa-credit-card' => 'credit',
    ]);
    ?>
							<div class="col-sm-<?php echo $this->getColumnWidth();
    if ($first) {
